...
public class KafkaController {
  ...
  private final DefaultKafkaTopicSenderGateway defaultKafkaTopicSenderGateway;

  @Operation(summary = "Creates a new kafka event")
  ...
  public void createAccount(
    ...
    defaultKafkaTopicSenderGateway.send(transaction);
  }
}
